          ...
          {isComplete ? (
            ...
            >
              ...
              <h2 className="text-2xl font-bold text-foreground mb-2">
                {isExercise ? 'Exercise Complete!' : 'Lesson Complete!'}
              </h2>
              <p className="text-muted-foreground mb-6">
                {nextLesson ? 'Ready for the next lesson?' : 'You\'ve finished this unit!'}
              </p>
              ...
              {isExercise ? (
                ...
                <>
                  ...
                  <div className="flex justify-center">
                    ...
                    >
                      {nextLesson?.type === 'exercise' ? 'Start Exercise' : 'Complete Lesson'}
                      <ArrowRight className="w-4 h-4" />
                    </Button>
                  </div>
                </>
