  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center p-4 sm:p-8">
      ...
      <div className="relative mx-auto max-w-2xl w-full px-4 sm:px-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-[#007AFF]/20 via-transparent to-[#007AFF]/20 rounded-3xl blur-3xl animate-pulse" style={{ animationDuration: '4s' }}></div>
        ...
        <motion.div
          ...
          className="relative bg-gradient-to-br from-[#0D0D0D] via-[#1A1A1A] to-[#0D0D0D] border-2 border-[#007AFF] rounded-3xl overflow-hidden shadow-2xl shadow-[#007AFF]/30"
          style={{ zIndex: 2 }}
        >
          ...
          <div className="absolute inset-0 pointer-events-none">
            <div className="absolute top-6 left-6 w-12 h-12 border-t-2 border-l-2 border-[#007AFF]/50 rounded-tl-lg"></div>
            <div className="absolute top-6 right-6 w-12 h-12 border-t-2 border-r-2 border-[#007AFF]/50 rounded-tr-lg"></div>
            <div className="absolute bottom-6 left-6 w-12 h-12 border-b-2 border-l-2 border-[#007AFF]/50 rounded-bl-lg"></div>
            <div className="absolute bottom-6 right-6 w-12 h-12 border-b-2 border-r-2 border-[#007AFF]/50 rounded-br-lg"></div>
          </div>
          ...
          <div className="relative z-10 bg-gradient-to-b from-black/50 via-black/30 to-transparent flex flex-col items-center justify-center gap-3 sm:gap-4 pt-8 sm:pt-12 pb-6 sm:pb-10">
            ...
            {/* Shape Name Badge */}
            <div className="px-4 sm:px-5 py-1.5 sm:py-2 bg-gradient-to-r from-[#0D0D0D]/90 to-[#1A1A1A]/90 border border-[#007AFF]/50 rounded-full backdrop-blur-md shadow-lg shadow-[#007AFF]/20">
              <p className="text-xs sm:text-sm font-mono text-[#007AFF] tracking-[0.2em] font-bold">
          ...
          <div className="relative z-10 px-4 sm:px-8 pb-6 sm:pb-10 space-y-4 sm:space-y-6">
            ...
            <div className="text-center space-y-1 sm:space-y-2">
              ...
              <p className="text-base sm:text-lg md:text-xl font-bold text-[#007AFF]">{userName}</p>
            </div>

            {/* Stats - Compact Single Row */}
            <div className="flex justify-center items-center gap-2 sm:gap-4 py-2">
              <div className="flex items-center gap-1.5">
                <div className="text-xl sm:text-2xl font-bold text-[#007AFF] font-mono">{score}</div>
                <div className="text-[10px] text-gray-500 font-mono">PTS</div>
              </div>
              <div className="w-px h-6 bg-gray-600/50"></div>
              <div className="flex items-center gap-1.5">
                <div className="text-xl sm:text-2xl font-bold text-white font-mono">{completedLessons}</div>
                <div className="text-[10px] text-gray-500 font-mono">LESSONS</div>
              </div>
              <div className="w-px h-6 bg-gray-600/50"></div>
              <div className="flex items-center gap-1.5">
                <div className="text-xl sm:text-2xl font-bold text-[#007AFF] font-mono">100%</div>
              </div>
            </div>
            ...
            <div className="flex justify-center">
              {(() => {
                ...
                if (score >= 180) {
                  ...
                  icon = <Target className="w-4 h-4 text-[#007AFF]" />;
                } else {
                  badge = 'CLARITY CHAMPION';
                  icon = <CheckCircle className="w-4 h-4 text-[#007AFF]" />;
                }

                return (
                  <div className="bg-gradient-to-r from-[#1A1A1A] to-[#0D0D0D] border border-[#007AFF]/30 rounded-full px-4 py-2 flex items-center gap-2 shadow-lg shadow-[#007AFF]/10">
                    {icon}
                    <span className="text-xs font-mono text-gray-400 tracking-wider">{badge}</span>
                  </div>
                );
              })()}
            </div>
            ...
            <div className="border-t border-gray-700/50 pt-3 sm:pt-4 text-center space-y-1">
              <div className="text-sm sm:text-base font-bold text-[#007AFF] tracking-wide">Novagen Labs</div>
            ...
            <div className="bg-gradient-to-r from-[#007AFF]/10 to-[#007AFF]/5 border border-[#007AFF]/30 rounded-xl p-3 sm:p-4 text-center shadow-lg shadow-[#007AFF]/10">
              <div className="text-[10px] sm:text-xs text-gray-500 tracking-wider">Try it yourself:</div>
              <div className="text-xs sm:text-sm font-bold text-[#007AFF] font-mono tracking-wide mt-1">
                learn2prompt.xyz
              </div>
